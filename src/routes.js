...
const Dashboard = React.lazy(() => import('./views/overview/Overview'))
...
const Evaluate = React.lazy(() => import('./views/evaluate/Evaluate'))
const Display = React.lazy(() => import('./views/display/Display'))
